...
INSERT INTO sessions VALUES('sess-5ywpuky85d','usr-z7x7dq9n','admin@theslidebee.com','admin','Browser',NULL,'2026-09-25 09:51:34','2026-10-02T09:51:34.747Z');
...
INSERT INTO profiles VALUES('prf-3txgrvmb','admin@theslidebee.com','admin','Enterprise',NULL,'admin',5,5,0,'[{"id":"f8fd0ba9-e940-4f6f-aa0e-dca64dd3e9c4","slug":"slidebee-1-","code":"SLD-301","title":"SlideBEE (1)","category":"Pitch Decks","slides_count":1,"formats":["Master PowerPoint (.pptx)"],"amount":0,"currency":"INR","download_url":"https://pub-7b09eb3d8c7349848cd1ce14cd290c56.r2.dev/templates/slides/accenture_slide-1.jpg","is_credit_redemption":true,"purchased_at":"2026-09-25T09:51:44.175Z"}]','[]','2026-09-25 09:51:34','2026-09-25 09:51:34','2026-09-25 09:51:44','free',NULL,0,NULL,0,NULL,0);
...
INSERT INTO orders VALUES('ord-y1shs5m','2026-09-25 09:51:44','CRD-VXEKA4V4','Starter Credit Claim: SlideBEE (1)','1','Instant Credit Dispatch','["Master PowerPoint (.pptx)"]',NULL,NULL,'Redeemed via 5 starter credits.','admin','admin@theslidebee.com',NULL,NULL,NULL,'completed');
...
CREATE INDEX idx_download_logs_email ON download_logs(user_email, downloaded_at);
CREATE INDEX idx_download_logs_template ON download_logs(template_id);
CREATE INDEX idx_templates_is_premium ON templates(is_premium, is_published);
COMMIT;
